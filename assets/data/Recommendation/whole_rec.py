...
# Example usage
input_features = {
    'tags': [5,7,9],  # Example tags
    'rating': 4.5
}
user_id = 0  # Replace with the actual user_id

recommended_items = weighted_hybrid_recommend(input_features, user_id, model, ncf_model, whole_data, user_id_to_index, cb_weight=0.8, cf_weight=0.2, k=10)
