  ...
  return (
    <SafeAreaView style={{flex:1,backgroundColor:"#101114", width:"100%",height:"100%"}}>
        <ScrollView showsVerticalScrollIndicator={false} style={{}} contentContainerStyle={{ height: '100%' }}>
            ...
            <View style = {{flex:1}}>
                <Text style = {{marginTop:10,fontFamily:FONT.regular,color:"white",justifyContent:'center',alignSelf:"center",}}>Pick The Date Interval</Text>
                <Text style = {{marginTop:30,fontFamily:FONT.regular,color:"white",justifyContent:'center',alignSelf:"center",}}>DATE PICKER WILL COME HERE </Text>
                <Text style = {{marginTop:10,fontFamily:FONT.regular,color:"white",justifyContent:'center',alignSelf:"center",}}>FOR DA FUCKING INTETVAL</Text>
